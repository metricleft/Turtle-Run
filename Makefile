...
STUDENT_LIBS = vector list polygon color body scene forces collision entity shapelib enemy frame powerup
...
LIBS = $(LIB_MATH) $(shell sdl2-config --libs) -lSDL2_gfx -lSDL2_image -lSDL2_mixer
...
LIBS = SDL2main.lib SDL2.lib SDL2_gfx.lib shell32.lib SDL2_image.lib SDL2_mixer.lib
