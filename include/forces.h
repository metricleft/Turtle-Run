...
/**
 * Returns the reduced mass between two bodies.
 * 
 * @param body1 the first body
 * @param body2 the second body
 * @returns a double representing the reduced mass between two bodies
 */
...
/**
 * Adds a force creator to a scene that destroys one of the two bodies and
 * resolves the collision when they collide. The other body is removed.
 * 
 * @param scene the scene containing the bodies
 * @param body1 the non-destroyed body
 * @param body2 the body destroyed on collision
 */
