...
/**
 * Returns the cartesian coordinates corresponding to the given polar coordinates
 *
 * @param r the r component of the polar coordinates
 * @param theta the theta component of the polar coordinates
 * @return a vector_t representing cartesian coordinates
 */
...
/**
 * Gives the unit vector of a given vector
 * 
 * @param v the vector to find unit vector
